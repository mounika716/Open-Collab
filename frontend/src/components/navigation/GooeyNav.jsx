...
const GooeyNav = ({
  ...
  /*
   * Randomness is only used while creating particles.
   * These functions are not executed during React render.
   */
   ...
   * We avoid setting state synchronously inside the effect.
   */
  useEffect(() => {
